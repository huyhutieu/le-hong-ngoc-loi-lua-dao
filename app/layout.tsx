...
export const metadata: Metadata = {
  title: 'Cảnh Báo Lừa Đảo Quịch Tiền | Lê Hồng Ngọc Lợi',
  description: 'Trang web cảnh báo cộng đồng về đối tượng lừa đảo. Cập nhật thông tin mới nhất về các chiêu trò lừa đảo phổ biến.',
  ...
  openGraph: {
    title: 'Cảnh Báo Lừa Đảo Quịch Tiền | Lê Hồng Ngọc Lợi',
    description: 'Chia sẻ và cập nhật thông tin về đối tượng Lê Hồng Ngọc Lợi lừa đảo để cảnh báo cộng đồng',
  ...
  twitter: {
    ...
    images: ['/images/fscammer-poster.png'],
  },
